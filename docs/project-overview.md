...
| Chat-first config & Web UI settings | In Progress | Typed control-plane config contracts/gateway are implemented; full chat authoring UX and Web UI management surfaces for items like LLMs, Telegram bots, and client configs are pending |
